...
TRX_ID1=$(curl -s -X POST \
  ...
  -d '{
	...
	"args":["B","002000000001" , "004000000001" , "A07103" , "102000","100000","true","BANK002B00200000000120180512134656","BANKCBC"]
}')
echo "Transacton ID is $TRX_ID1"
echo
echo
...
TRX_ID2=$(curl -s -X POST \
  ...
  -d '{
	"peers": ["peer0.org1.example.com","peer1.org1.example.com"],
	"fcn":"submitApproveTransaction",
	"args":["B","004000000001" , "002000000001" , "A07103" , "102000","100000","true","BANK004B00400000000120180512134702","BANKCBC"]
}')
echo "Transacton ID is $TRX_ID2"
echo
echo
