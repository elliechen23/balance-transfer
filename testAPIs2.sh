...
TRX_ID11=$(curl -s -X POST \
  ...
  -d '{
	"peers": ["peer0.org1.example.com","peer1.org1.example.com"],
	"fcn":"changeSecurity",
	"args":["A07106","107A06","2018/06/02","2028/06/02","1","10","25000000000","002000000001","002","10000000","0"]
}')
...
TRX_ID12=$(curl -s -X POST \
  ...
  -d '{
	"peers": ["peer0.org1.example.com","peer1.org1.example.com"],
	"fcn":"changeSecurity",
	"args":["A07106","107A06","2018/06/02","2028/06/02","1","10","25000000000","002000000002","002","10000000","0"]
}')
...
TRX_ID13=$(curl -s -X POST \
  ...
  -d '{
	"peers": ["peer0.org1.example.com","peer1.org1.example.com"],
	"fcn":"changeSecurity",
	"args":["A07106","107A06","2018/06/02","2028/06/02","1","10","25000000000","004000000001","004","10000000","0"]
}')
...
TRX_ID14=$(curl -s -X POST \
  ...
  -d '{
	"peers": ["peer0.org1.example.com","peer1.org1.example.com"],
	"fcn":"changeSecurity",
	"args":["A07106","107A06","2018/06/02","2028/06/02","1","10","25000000000","004000000002","004","10000000","0"]
}')
